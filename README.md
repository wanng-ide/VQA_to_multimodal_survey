...
与2022.1.3完成**第二版**的撰写，并且更新在了Github。
...
- [0. 本文结构](#0-----)
- [1. VQA任务简介](#1-vqa----)
  * [VQA和NLP任务的区别](#vqa-nlp-----)
  * [VQA和CV任务的区别](#vqa-cv-----)
    + [基于对象检测的任务](#---------)
    + [图像描述任务](#------)
- [2. VQA 相关的数据集（datasets）](#2-vqa--------datasets-)
  * [DAQUAR](#daquar)
  * [COCO-QA](#coco-qa)
  * [VQA数据集](#vqa---)
    + [VQA v1](#vqa-v1)
    + [VQA v2](#vqa-v2)
  * [Visual Madlibs](#visual-madlibs)
...
- [3. 主流模型与方法](#3--------)
  * [3.1 非深度学习方法](#31--------)
    + [回答类型预测 Answer Type Prediction (ATP)](#-------answer-type-prediction--atp-)
    + [多元世界问答 Multi-World QA](#-------multi-world-qa)
  * [3.2 无注意机制的深度学习模型 Non-attention Deep Learning Models](#32--------------non-attention-deep-learning-models)
    + [iBOWING](#ibowing)
    + [Full-CNN](#full-cnn)
    + [神经元询问 Ask Your Neurons (AYN)](#------ask-your-neurons--ayn-)
    + [Vis + LSTM](#vis---lstm)
    + [Vanilla VQA (deeper LSTM Q + norm I)](#vanilla-vqa--deeper-lstm-q---norm-i-)
    + [动态参数预测 Dynamic Parameter Prediction (DPPnet)](#-------dynamic-parameter-prediction--dppnet-)
  * [3.3 基于 Attention 的模型 Attention Based Models](#33----attention-----attention-based-models)
    + [Where To Look（WTL）](#where-to-look-wtl-)
    + [循环空间注意 Recurrent Spatial Attention (R-SA)](#-------recurrent-spatial-attention--r-sa-)
    + [堆叠注意网络 Stacked Attention Networks (SAN)](#-------stacked-attention-networks--san-)
    + [层次协同注意 Hierarchical Co-Attention model](#-------hierarchical-co-attention-model)
    + [双重注意网络 DAN](#-------dan)
    + [Tips and Tricks for Visual Question Answering](#tips-and-tricks-for-visual-question-answering)
    + [Pythia v0.1](#pythia-v01)
    + [Focal Visual-Text Attention (FVTA)](#focal-visual-text-attention--fvta-)
  * [3.4 其它有趣的模型](#34--------)
    + [MCBP for VQA](#mcbp-for-vqa)
    + [神经模块网络 Neural Module Network (NMN)](#-------neural-module-network--nmn-)
    + [AMA based on KB](#ama-based-on-kb)
    + [NS-VQA](#ns-vqa)
    + [差分网络 Differential Networks](#-----differential-networks)
  * [3.5 暂时的小结](#35------)
  * [3.6 基于 Transformer (BERT) 的模型 Transformer Based Models](#36----transformer--bert------transformer-based-models)
    + [ViLBERT](#vilbert)
